...
//         Created:  Wed, 12 May 2021 05:42:29 GMT
//
//
...
class Ntuplizer : public edm::stream::EDProducer<> {
   public:
...
void
Ntuplizer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
Ntuplizer::beginStream(edm::StreamID)
{
}
